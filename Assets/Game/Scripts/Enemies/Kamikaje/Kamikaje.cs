...
namespace Game.Scripts.Enemies.Kamikaje
{
    ...
    {
        [Header("Kamikaje References: ")] [SerializeField]
        private GameObject mechGameObject;
        ...
        protected override Dictionary<Type, IState> GetStates()
        {
            return new Dictionary<Type, IState>
            {
                ...
                { typeof(DeadState), new DeadState(enemyAI, deathParticle, mechGameObject, mainCollider, this) }
            };
        }
